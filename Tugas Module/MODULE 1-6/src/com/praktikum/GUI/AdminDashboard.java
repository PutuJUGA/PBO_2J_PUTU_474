...
public class AdminDashboard extends VBox {
    ...
    private void handleClaimed() {
        ...
        if (selected != null && selected.getStatus().equals("Reported")) {
            ...
            alert.setHeaderText("DATA CLAIMNED");
            alert.setContentText(
                    "Nama Barang: " + selected.getItemName() + "\n" +
                            "Deskripsi: "+selected.getDescription()+ "\n"+
                            "Lokasi: " + selected.getLocation() + "\n"
    ...
    private void handleTambahMahasiswa() {
        ...
        if (!nama.isEmpty() && !nim.isEmpty()) {
            ...
            alert.setContentText(
                    "Nama Mahasiswa: " + namaField.getText() + "\n" +
                            "Deskripsi: "+ nimField.getText()+ "\n"
            );
            alert.showAndWait();
        }
    }
